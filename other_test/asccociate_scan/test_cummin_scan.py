...
# >>> inp: tensor([[-1.3545,  0.7046]], device='npu:0', dtype=torch.float16)
# >>> inp.shape: torch.Size([1, 2])
# >>> dim: -1
# >>> 1. ref_out.values: tensor([[-1.3545, -1.3545]], device='npu:0', dtype=torch.float16)
# >>> 1. ref_out.indices: tensor([[0, 0]], device='npu:0')
# >>> scan_then_fan_col
# >>> part_num: 1
# Dumping intermediate results to /home/coder/.triton/dump/4oOGizp0kxO4DzwmrevjuuFA7aFZN2_xYssjtR4Z7X0
# Dumping launcher_cxx11abi1.cxx to /home/coder/.triton/dump/RwNlgWIE7x1bbPGFWx3lfV8EamPGfL2mWg4Z7lEvVZA
# >>> 2. res_out.values: tensor([[-1.3545, -1.3545]], device='npu:0', dtype=torch.float16)
# >>> 2. res_out.indices: tensor([[0, 0]], device='npu:0')
# >>> test passed!
